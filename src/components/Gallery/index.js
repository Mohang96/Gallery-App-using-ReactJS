...
class Gallery extends Component {
  state = {
    ...
    imageUrl:
      'https://assets.ccbp.in/frontend/react-js/nature-mountain-with-pond-img.png',
    imageAltValue: 'nature mountain with pond',
  }

  onClickThumbNail = (url, altText, id) => {
    this.setState({
      imageUrl: url,
      imageAltValue: altText,
      activeThumbNailId: id,
    })
  }

  render() {
    const {imageUrl, imageAltValue, activeThumbNailId} = this.state

    return (
      <div className="background">
        <div>
          <img src={imageUrl} alt={imageAltValue} />
